...
const Training = ({ data }) => {
  return (
    <>
      <Helmet
        title="Personal Training in Ashby | FREE Taster Session | Fitness Republic Gym"
        meta={[
          {
            name: "description",
            content:
      ...
      <Container>
        <DualSection>
          <InfoBubble
            location={"content"}
            headshot={data.blankahead.childImageSharp.gatsbyImageData}
            name={"Blanka"}
          />
          <TextSection
            pos="2/-1"
          ...
          />
          <Image
            pic={data.simonclient.childImageSharp.gatsbyImageData}
