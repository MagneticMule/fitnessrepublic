...
const Index = ({ data }) => {
  return <>
    <Helmet
      title="Fitness Republic - Family Gym in Ashby De La Zouch"
      meta={[
        {
          name: "description",
          content:
        ...
        <SuperBullet
          ...
          body={
            <>
              ...
              for your first visit. If you prefer to chat to a real life human
              being you can <strong>call us directly on 01530 413330</strong>{" "}
