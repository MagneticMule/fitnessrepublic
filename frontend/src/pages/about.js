    ...
    <>
      ...
      <Container>
        <DualSection>
          ...
          />
          <ImageGallery
            pic1={data.simontreadmill.childImageSharp.gatsbyImageData}
            pic2={data.jacquibench.childImageSharp.gatsbyImageData}
            pic3={data.marcusdumbells.childImageSharp.gatsbyImageData}
          />
          {/* <ReviewSection /> */}
          {/* <InfoBubble /> */}
          <TextSection
